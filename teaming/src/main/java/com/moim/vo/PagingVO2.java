 ...
 * 
 */
public class PagingVO2 implements Serializable {
	//TODO : 소모임 공지는 페이징 다른것 상속해서 변수 변경해야함
	
	//입력받는 데이터
	private int curPage=1;           // 현재 페이지 번호
	private int rowSizePerPage=3;   // 한 페이지당 레코드 수      기본10
	...
	public void pageSetting() {
		// 총 레코드가 200개이면
		totalPageCount = totalRowCount / rowSizePerPage + (totalRowCount % rowSizePerPage == 0? 0 : 1);		// 전체 페이지는 20개
		// 페이지가 6번 일 때는 51
